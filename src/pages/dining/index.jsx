  ...
  const handleCheckin = async (id) => {
    try {
      ...
      notification.success({
        message: "Check-In  status successfully updated not place some order",
      });
      fetchData();
    } catch (err) {
      ...
      case "CheckIn":
        return (
          <div className="flex justify-evenly">
            ...
            >
              Browse {collectBookingIds.includes(data._id) ? "More" : "Your"}{" "}
              Food
            </div>
          </div>
        );
  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="w-screen lg:px-20 px-4 lg:pt-20 pt-10 flex flex-col gap-y-10">
        ...
        {/* table */}
        <Skeleton loading={loading} className="lg:!w-[500px] lg:!h-[400px]">
                          ...
                          <div className="flex flex-col gap-y-1">
                            ...
                            <div className="text-[#4D4D4D] ">
                              ...
                              <div className="flex flex-col-reverse gap-y-4 gap-x-2">
                                ...
                                <div
                                  className={`${
                                    collectBookingIds.includes(res._id)
                                      ? "visible"
                                      : "invisible"
                                  }`}
                                >
      ...
      <div className="!w-screen">
        <Modal
          ...
          footer={false}
        >
          <AllCusines selectedCurrentTable={selectedCurrentTable || []} />
        </Modal>
      </div>
    </div>
  );
