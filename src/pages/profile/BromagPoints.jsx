...
import { tokenVerification, getMyPoints } from "../../helper/api/apiHelper";
...
const BromagPoints = () => {
  ...
  const getMonthOptions = () => {
    ...
    for (let i = 11; i >= 0; i--) {
      const monthName = new Date(previousYear, i).toLocaleString("default", {
        month: "long",
      });
      ...
      <div className="profile_head">
        ...
        {loading ? (
          ...
          <div className="space-y-6 mt-11">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border-2 border-dashed border-yellow-300 rounded-lg p-6">
              <div className="text-center">
                ...
                <p className="text-yellow-700 mb-4">
                  Every ₹10 spent = 1 Bromag Point. Reach milestones to unlock
                  exclusive benefits!
                </p>
